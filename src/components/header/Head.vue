  ...
  <header
    ...
    <section class="right">
      <div
        ...
        <div v-if="unreadMessage" class="menu-dot"></div>
      </div>
    </section>
    <div
      class="menu"
      ...
      <div
        class="item"
        @click.stop="goConversation()">
        <i class="iconfont icon-xiaoxi"></i>
        <span>消息</span>
        <div v-if="unreadMessage" class="dot"></div>
      </div>
      <div
        class="item"
        @click.stop="goSearchProducts()">
