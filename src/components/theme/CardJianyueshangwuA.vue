      ...
      <div class="top">
        ...
        <div class="option-wrapper">
          <a class="img-btn" @click.stop="clickQrCodeBtn(store)">
            <img src="../../assets/theme/jianyueshangwua/erweima.png" class="qr-img">
          </a>
          <img src="../../assets/theme/jianyueshangwua/zixun.png" class="btn" @click.stop="navClick(store.id, store.service.name, 0)">
        </div>
      </div>
      <div class="bottom">
...
<style lang="scss" scoped>
  ...
  .card {
    ...
    background: url("../../assets/theme/jianyueshangwua/cardJianyueshangwua.png");
