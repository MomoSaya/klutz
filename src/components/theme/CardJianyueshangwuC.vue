      ...
      <div class="right">
        <div class="option-wrapper">
          <div class="btn-group">
            ...
            <img src="../../assets/theme/jianyueshangwuc/xiaoyoubanji.png" class="btn" @click.stop="navClick(store.id, store.service.name, 1)">
            <img src="../../assets/theme/jianyueshangwuc/xiaoyouqiye.png" class="btn" @click.stop="navClick(store.id, store.service.name, 2)">
            <img src="../../assets/theme/jianyueshangwuc/shiguangzhou.png" class="btn" @click.stop="navClick(store.id, store.service.name, 3)">
          </div>
        </div>
      </div>
    </div>
...
<style lang="scss" scoped>
  ...
  .card {
    ...
    background: url("../../assets/theme/jianyueshangwuc/cardJianyueshangwuc.png");
