  ...
  <section class="card-wrapper">
    <div class="card" @click.stop="handleClick(store)">
      ...
      <div class="right btn-group">
        ...
        <img src="../../assets/theme/jingdianshangwuc/shiguangzhou.png" class="btn" @click.stop="navClick(store.id, store.service.name, 3)">
      </div>
    </div>
  </section>
</template>
...
<style lang="scss" scoped>
  ...
  .btn-group {
    @include px2rem(padding-top, 27px);
    .btn {
