      ...
      next () {
        this.$store.dispatch('commonAction', {
          ...
          data: {
            ...
            organization_ids: getStore('guidParams') && getStore('guidParams').organization_ids.length > 0 ? getStore('guidParams').organization_ids : [],
            product_ids: getStore('guidParams') && getStore('guidParams').product_ids.length > 0 ? getStore('guidParams').product_ids : []
          },
          target: this,
          resolve: (state, res) => {
            if (res.data.success) {
