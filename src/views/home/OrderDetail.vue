<template>
  <section class="full-width container">
    ...
    <section class="address full-width message">
      <div class="flex icon-box">
        <i class="iconfont icon-liuyan primary font-25"></i>
      </div>
      <div class="content">
        <div class="row primary-text font-15 top">
          <span>买家留言：</span>
