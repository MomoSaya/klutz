...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getFavorites (q = this.searchParams, activeIndex = 0, pageIndex = 1, pageSize = 20, type = 'Product') {
      ...
      setFavoritesData (activeIndex, arr, pageIndex) {
        if (activeIndex === 0) {
          ...
          this.getFavorites(this.searchParams, 1, this.organizationPageIndex, this.organizationPageSize, 'Organization')
          ...
          this.getFavorites(this.searchParams, 2, this.personPageIndex, this.personPageSize, 'User')
      ...
      loadAProductsBottom () {
        if (!this.noMoreProducts) {
          this.productPageIndex += 1
          this.getFavorites(this.searchParams, 0, this.productPageIndex, this.productPageSize, 'Product')
        }
      },
