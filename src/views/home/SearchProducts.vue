<template>
  <section class="search-wrapper full-width">
    <product-search-bar
    ...
    <div class="foot-component">
      <foot v-show="!hasSearch" :has-link="true"></foot>
    </div>
    <div
      v-if="hasSearch"
...
<script>
  ...
  export default {
    ...
    beforeRouteLeave (to, from, next) {
      this.$store.dispatch('saveScroll', {name: 'SearchProducts', value: this.hasSearch ? this.$refs.searchProducts.scrollTop : 0})
