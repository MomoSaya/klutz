      ...
      <div class="flex card">
        <div class="flex content">
          ...
          <div class="name ellipsis">
            <span v-if="teams && teams.name" class="font-16 team-name">{{teams.name}}这个商城名字很长很长很长很长很长很长很长很长很长很长</span>
            <span v-else class="font-16">&nbsp;</span>
            <div class="flex icon-groups">
              ...
              <div class="flex favorite qr-code" @click="goQrPage()">
                <i class="iconfont icon-erweima"></i>
                <span class="font-12">空间二维码</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <section v-if="activeIndex === 0" key="one">
          <div
            ...
            <div class="section-content">
              <a
                v-for="item in preLoadCategoriesLength"
                :key="item"
                class="flex item">
  ...
  export default {
    ...
    methods: {
      ...
      handleScrollHeight () {
        ...
        this.height = 110 * rootFontSize / 75
      },
      goScroll (scroll) {
      ...
      goSingleCategory (id) {
        this.$router.push({name: 'CategoryProducts', params: {id: id}, query: {teamId: this.id}})
      },
      goCategories () {
      ...
      goQrPage () {
        ...
        this.$router.push({name: 'QrPage', query: {name: this.teams.company, state: this.teams.state, logo: this.teams.logo, hasHeader: true, url: `${window.location.protocol}//${window.location.host}/malls/${this.teams.id}${sharerUrl}`}})
      },
      ...
      getEnterprises (queryParams = '') {
        ...
        this.$store.dispatch('commonAction', {
          url: `/v1/mall/${this.id}/org_members`,
          method: 'get',
          params: {
      ...
      getPersonMembers (queryParams = '') {
        ...
        this.$store.dispatch('commonAction', {
          url: `/v1/mall/${this.id}/person_members`,
          method: 'get',
          params: {
            ...(queryParams ? {q: queryParams} : {}),
  ...
  .card {
    ...
    .content {
      ...
      .name {
        ...
        color: $white;
        @include px2rem(max-width, 390px);
        .team-name {
          font-weight: bold;
        }
        .icon-groups {
